...
#TP/TN prediction
    inputDB_test = CSV.read("F:\\UvA\\app\\PestMix1-8_100ug-L_NoTea_1ul_AllIon_pos_28_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
    ...
    # save, ouputing 2120 x 18 df, 0:1411; 1:709 = 0.7512; 1.4951
    savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_NoTea_1ul_AllIon_pos_28_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter.csv"
    CSV.write(savePath, inputDB_test)
    inputDB_test[inputDB_test.LABEL .== 1, :]
    
    Yy_test = deepcopy(inputDB_test[:, end-1])  # 0.7512; 1.4951
    samplepestW = []
    for w in Vector(Yy_test)
        if w == 0
            push!(samplepestW, 0.7512)
        elseif w == 1
            push!(samplepestW, 1.4951)
        end
    end 
    ...
    ## Average accuracy
        ...
        savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_NoTea_1ul_AllIon_pos_28_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTN.csv"
        CSV.write(savePath, inputDB_test)

    #show prediction performance
        inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\app\\PestMix1-8_100ug-L_NoTea_1ul_AllIon_pos_28_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTN.csv", DataFrame)
        describe((inputTestDB_withDeltaRiTPTN))[end-5:end, :]

        # DT: 1, 0.4660377358490566, 0.6826695656384988
        maxAE_val, MSE_val, RMSE_val = errorDetermination(inputTestDB_withDeltaRiTPTN[:, end-2], inputTestDB_withDeltaRiTPTN[:, end])
        # DT: -1.0020741831112288
        ...
        savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_NoTea_1ul_AllIon_pos_28_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTNpTP.csv"
