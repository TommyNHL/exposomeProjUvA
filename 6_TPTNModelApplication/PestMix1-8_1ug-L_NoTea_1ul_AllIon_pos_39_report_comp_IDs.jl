...
#handle MS/MS data
    ...
    inputDB1 = CSV.read("F:\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs.csv", DataFrame)
    ...
    savePath = "F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_check.csv"
    ...
    savePath = "F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_checked.csv"
...
#output csv __ x 15 df
    savePath = "F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_ready4CNLdf.csv"
    CSV.write(savePath, outputDf)

    inputTPTNdf = CSV.read("F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_ready4CNLdf.csv", DataFrame)
...
#create CNL df
    ...
    savePath = "F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_extractedWithCNLsList.csv"
    CSV.write(savePath, inputTPTNdf)

    inputTPTNdf = CSV.read("F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_extractedWithCNLsList.csv", DataFrame)
    ...
    dfCNLs = DataFrame(X, CNLfeaturesStr)
        insertcols!(dfCNLs, 1, ("ENTRY"=>collect(1:1922)))
    ...
    # saving csv
    savePath = "F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withCNLRideltaRi.csv"
        CSV.write(savePath, dfCNLs)
        println("done for saving csv")

    dfOutput = CSV.read("F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withCNLRideltaRi.csv", DataFrame)
...
#leverage
    ...
    # saving csv
    savePath = "F:\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_dataframeTPTNModeling.csv"
    CSV.write(savePath, dfOutput)

#TP/TN prediction
    inputDB_test = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
    ...
    # save, ouputing 246 x 18+1 df, 0:164; 1:82 = 
    savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_dataframeTPTNModeling_0d5FinalScoreRatioDEFilterSTD.csv"
    ...
    ## Average accuracy
        ...
        # save, ouputing testSet df 246 x 19+1 df
        savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv"
        CSV.write(savePath, inputDB_test)

    #show prediction performance
        inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv", DataFrame)
        describe((inputTestDB_withDeltaRiTPTN))[end-5:end, :]

        # 1, 0.5, 0.7071067811865476
        ...
        # save, ouputing trainSet df 246 x 19+1+2 df
        savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv"
    ...
    #count individual sample performance
        inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv", DataFrame)
        ...
        savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1ug-L_NoTea_1ul_AllIon_pos_39_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN_ind.csv"
        CSV.write(savePath, inputTestDB_withDeltaRiTPTN)
