...
#TP/TN prediction
    inputDB_test = CSV.read("F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-10dil_1ul_AllIon_pos_27_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
    ...
    # save, ouputing 2671 x 18 df, 0:1995; 1:676 = 0.6694; 1.9756
    savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-10dil_1ul_AllIon_pos_27_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter.csv"
    CSV.write(savePath, inputDB_test)
    inputDB_test[inputDB_test.LABEL .== 1, :]
    
    Yy_test = deepcopy(inputDB_test[:, end-1])  # 0.6694; 1.9756
    samplepestW = []
    for w in Vector(Yy_test)
        if w == 0
            push!(samplepestW, 0.6694)
        elseif w == 1
            push!(samplepestW, 1.9756)
        end
    end 
    ...
    ## Average accuracy
        ...
        savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-10dil_1ul_AllIon_pos_27_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTN.csv"
        CSV.write(savePath, inputDB_test)

    #show prediction performance
        inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-10dil_1ul_AllIon_pos_27_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTN.csv", DataFrame)
        describe((inputTestDB_withDeltaRiTPTN))[end-5:end, :]

        # DT: 1, 0.5353800074878323, 0.7316966635757145
        maxAE_val, MSE_val, RMSE_val = errorDetermination(inputTestDB_withDeltaRiTPTN[:, end-2], inputTestDB_withDeltaRiTPTN[:, end])
        # DT: -1.1058815356522564
        ...
        savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-10dil_1ul_AllIon_pos_27_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTNpTP.csv"
