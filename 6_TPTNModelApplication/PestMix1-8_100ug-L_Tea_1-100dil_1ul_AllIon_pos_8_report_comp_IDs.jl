...
#TP/TN prediction
    inputDB_test = CSV.read("F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-100dil_1ul_AllIon_pos_8_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
    ...
    # save, ouputing 2099 x 18 df, 0:1310; 1:789 = 0.8011; 1.3302
    savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-100dil_1ul_AllIon_pos_8_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter.csv"
    CSV.write(savePath, inputDB_test)
    inputDB_test[inputDB_test.LABEL .== 1, :]
    
    Yy_test = deepcopy(inputDB_test[:, end-1])  # 0.8011; 1.3302
    samplepestW = []
    for w in Vector(Yy_test)
        if w == 0
            push!(samplepestW, 0.8011)
        elseif w == 1
            push!(samplepestW, 1.3302)
        end
    end 
    ...
    ## Average accuracy
        ...
        savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-100dil_1ul_AllIon_pos_8_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTN.csv"
        CSV.write(savePath, inputDB_test)

    #show prediction performance
        inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-100dil_1ul_AllIon_pos_8_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTN.csv", DataFrame)
        describe((inputTestDB_withDeltaRiTPTN))[end-5:end, :]

        # DT: 1, 0.5126250595521677, 0.7159783932160019
        maxAE_val, MSE_val, RMSE_val = errorDetermination(inputTestDB_withDeltaRiTPTN[:, end-2], inputTestDB_withDeltaRiTPTN[:, end])
        # DT: -1.121544366436746
        ...
        savePath = "F:\\UvA\\app\\PestMix1-8_100ug-L_Tea_1-100dil_1ul_AllIon_pos_8_report_comp_IDs_dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatioDEFilter_PredictedTPTNpTP.csv"
