...
histogram!(trainDEFDf_0[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEFDf_1[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEFDf_0[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEFDf_1[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEFDf_0[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEFDf_1[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEFDf_1[:, "MONOISOTOPICMASS"], bins = 150, 
    subplot = 15, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MonoisotopicMass/1000)", xguidefontsize=10, 
...
# Saving
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\app\\outplot_TPTNDistrution_FeatureMonoisotopicMass.png")
