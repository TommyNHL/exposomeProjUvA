...
#= histogram!(trainDEFDf_0[:, "UsrMatchFragRatio"], bins = 150, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEFDf_1[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEFDf_0[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEFDf_1[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEFDf_0[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEFDf_1[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEFDf_1[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 15, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
