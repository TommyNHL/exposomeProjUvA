...
outplotTPTNdetaRiDistrution = plot(layout = layout, link = :both, 
        size = (1500, 1200), margin = (8, :mm), dpi = 300)

histogram!(trainDf_0[:, "MS2Error"], bins = 150, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDf_1[:, "MS2Error"], bins = 150, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDf_0[:, "MS2Error"], bins = 150, 
    subplot = 4, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDf_1[:, "MS2Error"], bins = 150, 
    subplot = 4, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDf_0[:, "MS2Error"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDf_1[:, "MS2Error"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDf_1[:, "MS2Error"], bins = 150, 
    subplot = 10, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
...
histogram!(trainDEFDf_0[:, "MS2Error"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEFDf_1[:, "MS2Error"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(MS2Error)", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 1", 
    fc = "skyblue", 
    lc = "skyblue", 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEFDf_0[:, "MS2Error"], bins = 150, 
    subplot = 5, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEFDf_1[:, "MS2Error"], bins = 150, 
    subplot = 5, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEFDf_0[:, "MS2Error"], bins = 150, 
    subplot = 8, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEFDf_1[:, "MS2Error"], bins = 150, 
    subplot = 8, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEFDf_1[:, "MS2Error"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "MS2Error", xguidefontsize=10, 
...
histogram!(trainDEFSDf_0[:, "MS2Error"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEFSDf_1[:, "MS2Error"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEFSDf_0[:, "MS2Error"], bins = 150, 
    subplot = 6, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEFSDf_1[:, "MS2Error"], bins = 150, 
    subplot = 6, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEFSDf_0[:, "MS2Error"], bins = 150, 
    subplot = 9, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEFSDf_1[:, "MS2Error"], bins = 150, 
    subplot = 9, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEFSDf_1[:, "MS2Error"], bins = 150, 
    subplot = 12, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of MS2Error", xguidefontsize=10, 
...
# Saving
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\app\\outplot_TPTNDistrution_FeatureMS2Error.png")
