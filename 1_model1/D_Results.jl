...
## import csv ##
    ...
    # 5048 x 932 df 
    inputCocamidesTrain = CSV.read("F:\\UvA\\0_scriptsChemicalSpace\\CocamideExtWithStartification_Fingerprints_train.csv", DataFrame)
    ...
    # 1263 x 932 df
    inputCocamidesTest = CSV.read("F:\\UvA\\0_scriptsChemicalSpace\\CocamideExtWithStratification_Fingerprints_test.csv", DataFrame)
