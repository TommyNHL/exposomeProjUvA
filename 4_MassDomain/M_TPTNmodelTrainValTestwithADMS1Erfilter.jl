...
# save, ouputing 119054 x 21 df, 0:83052; 1:36002 = 0.7167; 1.6534
savePath = "F:\\UvA\\dataframeTPTNModeling_TestDFwithhl0d5FinalScoreRatio2Filter.csv"
...
# save, ouputing 475245 x 21 df, 0:330818; 1:144427 = 0.7183; 1.6453
savePath = "F:\\UvA\\dataframeTPTNModeling_TrainDFwithhl0d5FinalScoreRatio2Filter.csv"
...
# save, ouputing 13278 x 18 df, 0:4432; 1:8846 = 1.4980; 0.7505
savePath = "F:\\UvA\\dataframeTPTNModeling_pestDFwithhl0d5FinalScoreRatio2Filter.csv"
...
describe((inputDB))[vcat(5,6,8,9,10,11,12, end-5), :]
describe((inputDB_test))[vcat(5,6,8,9,10,11,12, end-5), :]
describe((inputDB_pest))[vcat(5,6,8,9,10,11,12, end-2), :]
...
function optimRandomForestClass(inputDB, inputDB_test, inputDB_pest)
    ...
    while itr < 129
        ...
        for mod in model_r
            ...
            M_pest = inputDB_pest
            if mod == 8
                Xx_train = deepcopy(M_train[:, vcat(5,6,8,9,10,11,12)])
                Xx_val = deepcopy(M_val[:, vcat(5,6,8,9,10,11,12)])
                Xx_test = deepcopy(M_pest[:, vcat(5,6,8,9,10,11,12)])
            elseif mod == 9
                Xx_train = deepcopy(M_train[:, vcat(5,6,8,9,10,11,12, end-5)])
                Xx_val = deepcopy(M_val[:, vcat(5,6,8,9,10,11,12, end-5)])
                Xx_test = deepcopy(M_pest[:, vcat(5,6,8,9,10,11,12, end-2)])
            end
...
savePath = "F:\\UvA\\hyperparameterTuning_TPTNwithAbsDeltaRi3F_0d5FinalScoreRatio2_RFwithhlnew2Compare23.csv"
...
# save, ouputing 180 x 8 df
savePath = "F:\\UvA\\hyperparameterTuning_TPTNwithAbsDeltaRi3F_0d5FinalScoreRatio_LRnew1.csv"
CSV.write(savePath, optiSearch_df) =#
...
# save, ouputing 180 x 8 df
savePath = "F:\\UvA\\hyperparameterTuning_TPTNwithAbsDeltaRi3F_0d5FinalScoreRatio6_GBMsnew1.csv"
CSV.write(savePath, optiSearch_df) =#
