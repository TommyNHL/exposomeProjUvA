...
histogram!(trainDfall[:, "RI"], bins = 150, 
    ...
    titlefont = font(18), 
    dpi = 300)
    histogram!(trainDfapp[:, "MFpredictRI"], bins = 75, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "RTI Values", xguidefontsize=12, 
    ...
    titlefont = font(18), 
    dpi = 300)
    histogram!(trainDfapp[:, "CNLpredictRI"], bins = 75, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "RTI Values", xguidefontsize=12, 
...
histogram!(testDfall[:, "RI"], bins = 150, 
    ...
    titlefont = font(18), 
    dpi = 300)
    histogram!(testDfapp[:, "MFpredictRI"], bins = 75, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "RTI Values", xguidefontsize=12, 
    ...
    titlefont = font(18), 
    dpi = 300)
    histogram!(testDfapp[:, "CNLpredictRI"], bins = 75, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "RTI Values", xguidefontsize=12, 
