...
## handle MS/MS data ##
    ...
    inputDB1 = CSV.read("F:\\PestMix1-8_test_report_comp_IDs.csv", DataFrame)
...
## handle 8 features ##
    ...
    savePath = "F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_check.csv"
...
savePath = "F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_checked.csv"
...
savePath = "F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_ready4CNLdf.csv"
CSV.write(savePath, outputDf)

## create CNL df ##
inputTPTNdf = CSV.read("F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_ready4CNLdf.csv", DataFrame)
    ...
    savePath = "F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_extractedWithCNLsList.csv"
    CSV.write(savePath, inputTPTNdf)

    ## store data in a Matrix ##
    inputTPTNdf = CSV.read("F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_extractedWithCNLsList.csv", DataFrame)
    X = zeros(17385, 15961)
    #
    for i in 1:17385
        println(i)
...
## save csv ##
savePath = "F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_withCNLRideltaRi.csv"
CSV.write(savePath, dfCNLs)
println("done for saving csv")

## apply leverage filter ##
    dfOutput = CSV.read("F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_withCNLRideltaRi.csv", DataFrame)
    #
...
## save csv ##
savePath = "F:\\UvA\\app\\PestMix1-8_test_report_comp_IDs_dataframeTPTNModeling.csv"
