...
## OUTPUT(S)
# outplot_TPTNDistrution_FeatureMS2Error_noFilter.png
...
histogram!(trainDEFSDf_0[:, "MS2Error"], bins = 150, 
    ...
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized MS2Error", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\F\\UvA\\app\\outplot_TPTNDistrution_FeatureMS2Error_noFilter.png")
