...
#
histogram!(trainDf_0[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDf_1[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "UsrMatchFragRatio", xguidefontsize=10, 
...
histogram!(trainDEDf_0[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEDf_1[:, "UsrMatchFragRatio"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(UsrMatchFragRatio)", xguidefontsize=10, 
...
histogram!(trainDEFSDf_0[:, "UsrMatchFragRatio"], bins = 150, 
    ...
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(UsrMatchFragRatio)", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\F\\UvA\\app\\outplot_TPTNDistrution_FeatureUsrMatchFragRatio_noFilter.png")
