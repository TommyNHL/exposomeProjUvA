...
histogram!(trainDEFSDf_0[:, "RefMatchFragRatio"], bins = 150, 
    ...
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of log(RefMatchFragRatio)", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\app\\outplot_TPTNDistrution_FeatureRefMatchFragRatio_noFilter.png")
