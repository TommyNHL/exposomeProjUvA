...
histogram!(trainDEFSDf_0[:, "MS2ErrorStd"], bins = 150, 
    ...
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized MS2ErrorStd", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\F\\UvA\\app\\outplot_TPTNDistrution_FeatureMS2ErrorStd_noFilter.png")
