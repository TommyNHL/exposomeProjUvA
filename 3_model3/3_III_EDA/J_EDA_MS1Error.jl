...
## OUTPUT(S)
# outplot_TPTNDistrution_FeatureMS1Error_noFilter.png
...
histogram!(trainDf_0[:, "MS1Error"], bins = 150, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDf_1[:, "MS1Error"], bins = 150, 
    subplot = 1, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1- Way MS1Error", xguidefontsize=10, 
...
histogram!(trainDEDf_0[:, "MS1Error"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEDf_1[:, "MS1Error"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "2-Way MS1Error", xguidefontsize=10, 
