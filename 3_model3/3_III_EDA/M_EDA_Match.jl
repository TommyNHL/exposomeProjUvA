...
## OUTPUT(S)
# outplot_TPTNDistrution_FeatureMatch_noFilter.png
...
histogram!(trainDEFSDf_0[:, "MatchDiff"], bins = 150, 
    ...
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized MatchDiff", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\F\\UvA\\app\\outplot_TPTNDistrution_FeatureMatch_noFilter.png")
