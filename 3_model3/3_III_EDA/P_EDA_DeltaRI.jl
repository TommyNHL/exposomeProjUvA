...
#= histogram!(trainDEFDf_0[:, "DeltaRi"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEFDf_1[:, "DeltaRi"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1-Way DeltaRI", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEFDf_0[:, "DeltaRi"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1-Way DeltaRI", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEFDf_1[:, "DeltaRi"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1-Way DeltaRI", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEFDf_0[:, "DeltaRi"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1-Way DeltaRI", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEFDf_1[:, "DeltaRi"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1-Way DeltaRI", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEFDf_1[:, "DeltaRi"], bins = 150, 
    subplot = 15, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "1-Way DeltaRI", xguidefontsize=10, 
...
# Saving
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\F\\UvA\\app\\outplot_TPTNDistrution_FeatureDeltaRi_noFilter_fig3.png")
