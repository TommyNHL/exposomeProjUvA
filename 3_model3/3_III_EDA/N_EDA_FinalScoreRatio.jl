...
histogram!(trainDEFSDf_0[:, "FinalScoreRatio"], bins = 150, 
    ...
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "z-score of log(FinalScoreRatio)", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\app\\outplot_TPTNDistrution_FeatureFinalScoreRatio_noFilter.png")
