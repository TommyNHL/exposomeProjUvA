...
## OUTPUT(S)
# outplot_TPTNDistrution_FeatureFinalScoreRatio_noFilter.png
...
histogram!(testDf_0[:, "FinalScoreRatio"], bins = 150, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "FinalScoreRatio", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 7, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "FinalScoreRatio", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 10, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "FinalScoreRatio", xguidefontsize=10, 
...
histogram!(trainDEDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 2, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 5, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 5, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 8, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 8, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 11, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "log(FinalScoreRatio)", xguidefontsize=10, 
...
histogram!(trainDEFSDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
    ylabel = "Count", yguidefontsize=10, 
    label = "LABEL 0", 
    fc = "pink", 
    lc = "pink", 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(trainDEFSDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 3, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(testDEFSDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 6, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(testDEFSDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 6, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(noTeaDEFSDf_0[:, "FinalScoreRatio"], bins = 150, 
    subplot = 9, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
    histogram!(noTeaDEFSDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 9, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
    ...
    titlefont = font(12), 
    dpi = 300)
histogram!(TeaDEFSDf_1[:, "FinalScoreRatio"], bins = 150, 
    subplot = 12, 
    framestyle = :box, 
    seriestype=:stephist, 
    xlabel = "Normalized log(FinalScoreRatio)", xguidefontsize=10, 
...
## save ##
savefig(outplotTPTNdetaRiDistrution, "F:\\UvA\\F\\UvA\\app\\outplot_TPTNDistrution_FeatureFinalScoreRatio_noFilter.png")
