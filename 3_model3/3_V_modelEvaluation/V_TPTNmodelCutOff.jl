...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        size = (1400,600), 
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n111,519"], subplot = 1, font(color="white"))
        annotate!(["0"], ["1"], ["FP\n121,551"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n39,791"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n1,413,458"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_TestWith, cmap = :viridis, cbar = :true, 
        clims = (0, 150000), 
        subplot = 2, 
        ...
        size = (1400,600), 
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n27,660"], subplot = 2, font(color="white"))
        annotate!(["0"], ["1"], ["FP\n30,880"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n10,305"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n352,536"], subplot = 2)
savefig(TrainOutplotCM, "F:\\UvA\\F\\UvA\\app\\TPTNPrediction_KNNtrainTestCM10FDR.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_PestWith, cmap = :viridis, cbar = :true, 
        ...
        size = (1400,600), 
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n1,336"], subplot = 1, font(color="white"))
        annotate!(["0"], ["1"], ["FP\n1,162"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n2,399"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n6,011"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_Pest2With, cmap = :viridis, cbar = :true, 
        clims = (0, 9000), 
        subplot = 2, 
        ...
        size = (1400,600), 
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n2,621"], subplot = 2, font(color="white"))
        annotate!(["0"], ["1"], ["FP\n0"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n5,566"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n0"], subplot = 2, font(color="white"))
savefig(PestOutplotCM, "F:\\UvA\\F\\UvA\\app\\TPTNPrediction_KNNpestPest2CM10FDR.png")
