...
inputDB_test = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
...
## save ##, ouputing 1201 x 18+1 df, 0:641; 1:560 = 
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_dataframeTPTNModeling_0d5FinalScoreRatioDEFilterSTD.csv"
...
## deploy models for training set ##
    ...
    #
## save ##, ouputing testSet df 1201 x 19+1 df
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv"
CSV.write(savePath, inputDB_test)

## evaluate predictive performance of the model with DeltaRi ##
inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv", DataFrame)
    #
    maxAE_val, MSE_val, RMSE_val = errorDetermination(inputTestDB_withDeltaRiTPTN[:, end-2], inputTestDB_withDeltaRiTPTN[:, end])  # 1, 0.37885095753538717, 0.6155086981801209
    pTP_test = predict_proba(model, Matrix(inputTestDB_withDeltaRiTPTN[:, vcat(5, 7,9, 13,14, 17)]))  # 1201 × 2 Matrix
    recall_test = recall_score(Vector(inputTestDB_withDeltaRiTPTN[:, end-2]), predict(model, Matrix(inputTestDB_withDeltaRiTPTN[:, vcat(5, 7,9, 13,14, 17)])))  # 0.5678571428571428
    inputTestDB_withDeltaRiTPTN[!, "p(0)"] = pTP_test[:, 1]
    inputTestDB_withDeltaRiTPTN[!, "p(1)"] = pTP_test[:, 2]
    #
## save ##, ouputing trainSet df 1201 x 19+1+2 df
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv"
CSV.write(savePath, inputTestDB_withDeltaRiTPTN)


# ==================================================================================================
## count individual sample performance ##
inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv", DataFrame)
...
## save ##
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_25ug-L_NoTea_1ul_AllIon_pos_15_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN_ind.csv"
CSV.write(savePath, inputTestDB_withDeltaRiTPTN)
