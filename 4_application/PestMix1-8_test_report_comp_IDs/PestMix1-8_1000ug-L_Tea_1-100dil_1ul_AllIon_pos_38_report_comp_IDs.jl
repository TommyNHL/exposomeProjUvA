...
inputDB_test = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-100dil_1ul_AllIon_pos_38_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
...
## save ##, ouputing 4742 x 18+1 df, 0:3218; 1:1524 = 
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-100dil_1ul_AllIon_pos_38_report_comp_IDs_dataframeTPTNModeling_0d5FinalScoreRatioDEFilterSTD.csv"
...
## deploy models for training set ##
    ...
    #
## save ##, ouputing testSet df 4742 x 19+1 df
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-100dil_1ul_AllIon_pos_38_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv"
CSV.write(savePath, inputDB_test)

## evaluate predictive performance of the model with DeltaRi ##
inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-100dil_1ul_AllIon_pos_38_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv", DataFrame)
    #
    maxAE_val, MSE_val, RMSE_val = errorDetermination(inputTestDB_withDeltaRiTPTN[:, end-2], inputTestDB_withDeltaRiTPTN[:, end])  # 1, 0.3338253901307465, 0.5777762457307729
    pTP_test = predict_proba(model, Matrix(inputTestDB_withDeltaRiTPTN[:, vcat(5, 7,9, 13,14, 17)]))  # 4742 × 2 Matrix
    recall_test = recall_score(Vector(inputTestDB_withDeltaRiTPTN[:, end-2]), predict(model, Matrix(inputTestDB_withDeltaRiTPTN[:, vcat(5, 7,9, 13,14, 17)])))  # 0.6246719160104987
    inputTestDB_withDeltaRiTPTN[!, "p(0)"] = pTP_test[:, 1]
    inputTestDB_withDeltaRiTPTN[!, "p(1)"] = pTP_test[:, 2]
    #
## save ##, ouputing trainSet df 4742 x 19+1+2 df
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-100dil_1ul_AllIon_pos_38_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv"
