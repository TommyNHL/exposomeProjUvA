...
## input and pre-process sample TP/TN set ##
    inputDB_test = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_dataframeTPTNModeling.csv", DataFrame)
...
## save ##, ouputing 4808 x 18+1 df, 0:3474; 1:1334 = 
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_dataframeTPTNModeling_0d5FinalScoreRatioDEFilterSTD.csv"
...
## deploy models for training set ##
    ...
    #
## save ##, ouputing testSet df 4808 x 19+1 df
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv"
CSV.write(savePath, inputDB_test)

## evaluate predictive performance of the model with DeltaRi ##
inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_withDeltaRIandPredictedTPTN_KNN.csv", DataFrame)
    #
    maxAE_val, MSE_val, RMSE_val = errorDetermination(inputTestDB_withDeltaRiTPTN[:, end-2], inputTestDB_withDeltaRiTPTN[:, end])  # 1, 0.35232945091514145, 0.5935734587354302
    pTP_test = predict_proba(model, Matrix(inputTestDB_withDeltaRiTPTN[:, vcat(5, 7,9, 13,14, 17)]))  # 4808 × 2 Matrix
    recall_test = recall_score(Vector(inputTestDB_withDeltaRiTPTN[:, end-2]), predict(model, Matrix(inputTestDB_withDeltaRiTPTN[:, vcat(5, 7,9, 13,14, 17)])))  # 0.5982008995502249
    inputTestDB_withDeltaRiTPTN[!, "p(0)"] = pTP_test[:, 1]
    inputTestDB_withDeltaRiTPTN[!, "p(1)"] = pTP_test[:, 2]
    #
## save ##, ouputing trainSet df 4808 x 19+1+2 df
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv"
CSV.write(savePath, inputTestDB_withDeltaRiTPTN)


# ==================================================================================================
## count individual sample performance ##
inputTestDB_withDeltaRiTPTN = CSV.read("F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN.csv", DataFrame)
...
## save ##
savePath = "F:\\UvA\\F\\UvA\\app\\PestMix1-8_1000ug-L_Tea_1-10dil_1ul_AllIon_pos_43_report_comp_IDs_withDeltaRIandPredictedTPTNandpTP_KNN_ind.csv"
CSV.write(savePath, inputTestDB_withDeltaRiTPTN)
